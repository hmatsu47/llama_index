...
class PostgreSQLPropertyGraphStore(PropertyGraphStore):
    # PostgreSQL supports vector queries with pgvector
    ...
    def init_schema(self) -> Tuple:
        ...
        with self._engine.connect() as conn:
            conn.execute(sql.text(
                f"CREATE INDEX IF NOT EXISTS {self._node_table_name}_embedding_idx "
                f"ON {self._node_table_name} USING hnsw (embedding vector_cosine_ops) "
